...
namespace SerializacjaKlasyGuy
{
    ...
    class GuyManager : INotifyPropertyChanged
    {
        ...
        private Guy joe = new Guy("Marek", 50, 176.22M);
        public Guy Joe
        {
            get { return joe; }
        }

        private Guy bob = new Guy("Paweł", 21, 4.68M);
        public Guy Bob
        {
            get { return bob; }
        }

        private Guy ed = new Guy("Piotrek", 17, 37.51M);
        public Guy Ed
        {
            get { return ed; }
        }
        ...
        public async void WriteGuyAsync(Guy guyToWrite)
        {
            IStorageFolder guysFolder =
                await KnownFolders.DocumentsLibrary.CreateFolderAsync("Faceci",
